...
open class SkyFloatingLabelTextField: UITextField {
    ...
    @IBInspectable open var selectedTitleColor:UIColor = UIColor.init(colorLiteralRed: 44.0 / 255.0, green: 206.0 / 255.0, blue: 144.0 / 255.0, alpha: 1.0) {
        didSet {
            self.updateTitleColor()
        }
    }
    ...
    */
    ...
    fileprivate func configureDefaultLineHeight() {
        ...
        self.lineHeight = 0.0 * onePixel
        self.selectedLineHeight = 0.0 * self.lineHeight
    }
    ...
    */
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        ...
        let rect = CGRect(x: 0, y: titleHeight - 5, width: bounds.size.width, height: bounds.size.height - titleHeight - lineHeight)
        return rect
    }
    ...
    */
    open func titleLabelRectForBounds(_ bounds:CGRect, editing:Bool) -> CGRect {
        let titleHeight = self.titleHeight()
        if editing {
            return CGRect(x: 0, y: -2, width: bounds.size.width, height: titleHeight)
        }
