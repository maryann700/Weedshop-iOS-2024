...
open class BendableView: UIView, BendableLayerDelegate {
    ...
    open var fillColor: UIColor = UIColor(red: 55.0 / 255.0, green: 60.0 / 255.0, blue: 68.0 / 255.0, alpha: 1) {
    didSet {
        updateColor()
    }
    }
    ...
    func updateColor() {
        shapeLayer.fillColor = self.backgroundColor?.cgColor //fillColor.cgColor
    }
