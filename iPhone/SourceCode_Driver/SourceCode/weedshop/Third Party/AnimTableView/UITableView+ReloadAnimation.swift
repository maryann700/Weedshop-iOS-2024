...
class AnimTableView: UITableView {
    ...
    func reloadDataWithAnim(type:animType) {
        ...
        for i in stride(from: 0, through: cells.count - 1, by: 1)
        {
//            UIView.animate(withDuration: 2.2, delay: Double(i) * delay, usingSpringWithDamping: damping, initialSpringVelocity: 5.5, options: UIViewAnimationOptions.allowUserInteraction, animations: {
...
//            UIView.animate(withDuration: 2, delay: Double(i) * delay, usingSpringWithDamping: damping, initialSpringVelocity: 5, options: UIViewAnimationOptions.allowUserInteraction, animations: {
//                cells[i].transform = CGAffineTransform.init(translationX: 0, y: 0)
//            }, completion: nil)
//        }
